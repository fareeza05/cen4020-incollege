...
FILE-CONTROL.
    SELECT IN-FILE ASSIGN TO "tests/week8/jawaad/MSG-NEG-01-InCollege-Input.txt"
        ORGANIZATION IS LINE SEQUENTIAL.
    SELECT OUT-FILE ASSIGN TO "tests/week8/jawaad/MSG-NEG-01-Output.txt"
        ORGANIZATION IS LINE SEQUENTIAL.
...
01  JOB-REC.
    ...
    05 FILLER              PIC X VALUE "|".
    05 JOB-TITLE-FILE      PIC X(100).
    05 FILLER              PIC X VALUE "|".
    05 JOB-DESC-FILE       PIC X(200).
    05 FILLER              PIC X VALUE "|".
    05 JOB-EMPLOYER-FILE   PIC X(100).
    05 FILLER              PIC X VALUE "|".
...
01 WS-APP-VIEW-EOF        PIC X VALUE "N".
01 WS-APP-VIEW-COUNT      PIC 9(4) VALUE 0.

01 WS-VIEW-USER           PIC X(20).
01 WS-VIEW-TITLE          PIC X(100).
01 WS-VIEW-EMPLOYER       PIC X(100).
